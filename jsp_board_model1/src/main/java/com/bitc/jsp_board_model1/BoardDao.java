...
public class BoardDao extends JDBConnect{
  ...
  public List<BoardDto> selectList(){
    ...
    String sql = "SELECT num, title, id, postdate, visitcount FROM board ORDER BY num DESC"; // 숫자 내림차순으로 출력하기 위한 구문
  ...
  public List<BoardDto> selectList(int startNum, int postSize){
    ...
    // 게시물 목록을 가져올 SQL 쿼리 생성
    String sql = "SELECT num, title, id, postdate, visitcount FROM board "; // 숫자 내림차순으로 출력하기 위한 구문
